...
Games[] =
{
    ...
    // Airline Pilots (Rev B) 
    {
        ...
        ROT0,
        {
            ...
            { "main_eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        NULL,
        &alpilot_inputs
    ...
    // Dead or Alive 2 (JPN, USA, EXP, KOR, AUS)
    {
        ...
        ROT0,
        {
            ...
            { "841-0003.sf", 0, 0x84, NaomiBdEeprom },
            { NULL, 0, 0 },
        }
    },
    ...
    // Border Down (Rev A) (GDL-0023A)
    {
        ...
        ROT0,
        {
            ...
            { "bdrdown-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0023a",
    },
    // Chaos Field (Japan) (GDL-0025)
    {
        ...
        ROT0,
        {
            ...
            { "cfield-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0025",
    },
    ...
    // Mobile Suit Gundam: Federation Vs. Zeon (GDL-0001)
    {
        ...
        ROT0,
        {
            ...
            { "gundmgd-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0001",
    },
    // Mobile Suit Gundam: Federation Vs. Zeon DX (USA, Japan) (GDL-0006)
    {
        ...
        ROT0,
        {
            ...
            { "gundmxgd-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0006",
    },
    ...
    // Karous (Japan) (GDL-0040)
    {
        ...
        ROT270,
        {
            ...
            { "karous-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0040",
    },
    // La Keyboard (GDS-0017)
    {
        ...
        ROT0,
        {
            ...
            { "keyboard-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gds-0017",
    },
    ...
    // Moeru Casinyo (Japan) (GDL-0013)
    {
        ...
        ROT0,
        {
            ...
            { "moeru-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0013",
    },
    ...
    // Psyvariar 2 - The Will To Fabricate (Japan) (GDL-0024)
    {
        ...
        ROT270,
        {
            ...
            { "psyvar2-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0024",
    },
    // Puyo Pop Fever (World) (GDS-0034)
    {
        ...
        ROT0,
        {
            ...
            { "puyofev-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gds-0034",
    },
    ...
    // Quiz Keitai Q mode (GDL-0017)
    {
        ...
        ROT270,
        {
            ...
            { "quizqgd-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0017",
    },
    // Radirgy (Japan, Rev A) (GDL-0032A)
    {
        ...
        ROT270,
        {
            ...
            { "radirgy-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0032a",
    },
    ...
    // Senko No Ronde (Japan, Rev A) (GDL-0030A)
    {
        ...
        ROT0,
        {
            ...
            { "senko-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0030a",
    },
    // Senko No Ronde (Japan) (GDL-0030)
    {
        ...
        {
            { "317-5107-jpn.pic", 0, 0x4000 },
            { "senkoo-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0030",
    },
    ...
    // Street Fighter Zero 3 Upper (Japan) (GDL-0002)
    {
        ...
        ROT0,
        {
            ...
            { "sfz3ugd-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0002",
    },
    ...
    // Shikigami No Shiro II / The Castle of Shikigami II (GDL-0021)
    {
        ...
        ROT270,
        {
            ...
            { "shikgam2-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0021",
    },
    ...
    // Super Shanghai 2005 (Japan, Rev A) (GDL-0031A)
    {
        ...
        ROT0,
        {
            ...
            { "ss2005-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0031a",
    },
    ...
    // Tetris Kiwamemichi (Japan) (GDL-0020)
    {
        ...
        ROT0,
        {
            ...
            { "tetkiwam-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0020",
    },
    // Trigger Heart Exelica Ver.A (Japan) (GDL-0036A)
    {
        ...
        ROT270,
        {
            ...
            { "trgheart-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0036a",
    },
    ...
    // Trizeal (Japan) (GDL-0026)
    {
        ...
        ROT270,
        {
            ...
            { "trizeal-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0026",
    },
    // Under Defeat (Japan) (GDL-0035)
    {
        ...
        ROT270,
        {
            ...
            { "undefeat-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0035",
    },
    // Usagi - Yamashiro Mahjong Hen (Japan) (GDL-0022)
    {
        ...
        ROT0,
        {
            ...
            { "usagiym-default-eeprom.bin", 0, 0x80, MainEeprom },
            { NULL, 0, 0 },
        },
        "gdl-0022",
    },
